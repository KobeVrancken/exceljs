...
class WorksheetWriter {
  constructor(options) {
    ...
    // number of rows that in commit process.
    this._rowsInCommitProcessNumber = 0;
    ...
    // in commit process flag
    this.inCommitProcess = false;
  ...
  async commit() {
    ...
    this.stream.emit('worksheetsZipped');
